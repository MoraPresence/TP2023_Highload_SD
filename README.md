...
Наибольшая плотность населения России приходится на западную и юго-западную часть [^1].
Сеть CDN будет состоять из 100 серверов, расположенных по всей стране.
Сервера можно арендовать в ЦОДах существующих компаних, например, Selectel.
![img_1.png](img_1.png)
...
Формула(пример): Таблица Documents(1 запись): id(bigint)8Б + title(varchar(255))255Б + description(varchar(255))255Б + author(varchar(255))255Б + date(timestamp)8Б + link(varchar(255))255Б = 1036Б

Таблица Documents(1 запись): 320Б
Таблица Documents_info(1 запись): 534Б
...
**KeyWords:** b-tree(id)(P_KEY), hash(key_word)
...
| Сервис     | Хостинг | Конфигурация                         | Cores | Cnt | RPS   | 
|------------|---------|--------------------------------------|-------|-----|-------| 
| nginx      | own     | 2x6430/4x8GB/1xNVMe256Gb/2x100Gb/s   | 64    | 7   | 18500 | 
| Auth       | own     | 2x6430/8x16GB/1xNVMe256Gb/2x100Gb/s  | 128   | 20  | 16500 | 
| Srch-web   | own     | 2x6430/8x64GB/1xNVMe256Gb/2x100Gb/s  | 256   | 20  | 11112 | 
| Srch-img   | own     | 2x6430/8x16GB/1xNVMe256Gb/2x40Gb/s   | 128   | 16  | 4630  | 
| Srch-video | own     | 2x6430/8x16GB/1xNVMe256Gb/2x40Gb/s   | 128   | 16  | 2778  |
| Statistic  | own     | 2x6430/4x8GB/1xNVMe256Gb/2x10Gb/s    | 64    | 6   | 16500 | 
